...
export interface Category {
  ...
  navName: string;     // longer label used in navbar / footer
  emoji: string;
  tagline: string;
  description: string;
  accentFrom: string;  // gradient start (hero tint)
...
export interface Product {
  ...
  uses: string[];
  grades: string[];
  forms?: string[];    // variety toggle (e.g. Powder / Flakes / Granules)
  drying?: string;
}
...
export const products: Product[] = [
  // ---------------------------------------------------------------- FRUIT
  {
    ...
    features: ["100% fruit, no added sugar or colour", "Bright, natural guava aroma", "Free-flowing and easy to disperse", "Long, stable shelf life"],
    ...
    grades: ["Food grade", "Spray-dried", "80–100 mesh", "Moisture ≤ 5%"],
    drying: "Spray-dried",
  },
  {
    ...
    features: ["True pineapple tang and aroma", "Natural golden colour", "Dissolves quickly in water", "No artificial additives"],
  ...
  },
  {
    ...
    features: ["Naturally sweet, no added sugar", "Adds body and smooth texture", "Easy to reconstitute", "Versatile across sweet and savoury"],
  ...
  },
  {
    ...
    features: ["Sweet-tart apple character", "Clean label, single ingredient", "Blends evenly in dry mixes", "Long shelf life"],
  ...
  },
  {
    ...
    features: ["Ripe Alphonso/Totapuri character", "Vivid natural colour", "Excellent solubility", "No added sugar or flavour"],
  ...
  },
  {
    ...
    description:
      "Amla, or Indian gooseberry, is one of the most prized fruits in Ayurveda. Our air-dried amla powder retains its natural tartness and is widely used in supplements, hair and skin care, and functional foods for its antioxidant reputation.",
    features: ["Naturally rich in vitamin C", "Air-dried to protect actives", "Sharp, characteristic tartness", "Trusted Ayurvedic ingredient"],
    uses: ["Dietary supplements and tablets", "Hair oils and cosmetics", "Functional drinks and churnas", "Herbal blends and teas"],
    grades: ["Food / nutraceutical grade", "Air-dried", "80–100 mesh", "Moisture ≤ 7%"],
    drying: "Air-dried",
  },
  {
    ...
    features: ["Concentrated sour-sweet flavour", "Consistent acidity, no seeds", "Easy to weigh and disperse", "Long shelf life"],
    uses: ["Sauces, chutneys and ketchups", "Spice and seasoning blends", "Soups, broths and instant mixes", "Confectionery and beverages"],
    grades: ["Food grade", "Air-dried", "60–80 mesh", "Moisture ≤ 7%"],
    drying: "Air-dried",
  },
  {
    ...
    features: ["Mild, sweet papaya taste", "Source of natural enzymes", "Smooth, fine texture", "Clean single-ingredient label"],
  ...
  // ----------------------------------------------------- CULINARY & SPICE
  {
    ...
    features: ["Strong, sweet-pungent flavour", "Consistent pungency, batch to batch", "Available in five cut sizes", "No peeling, chopping or spoilage"],
    uses: ["Seasoning and spice blends", "Snacks, sauces and dressings", "Ready meals, soups and gravies", "Meat rubs and marinades"],
    grades: ["Food grade", "Hot-air dried", "Custom mesh / cut sizes", "Moisture ≤ 6%"],
    forms: POWDER_FORMS,
    drying: "Hot-air dried",
  },
  {
    ...
    features: ["Milder, clean onion flavour", "Pale colour for light products", "Five cut sizes available", "Uniform, reliable supply"],
  ...
  },
  {
    ...
    features: ["Pungent, true garlic flavour", "Dried, flakes and powder forms", "Clean white colour", "Long, stable shelf life"],
  ...
  },
  {
    ...
    features: ["Warm, pungent and aromatic", "Dried and powder forms", "High volatile-oil content", "Versatile in food and wellness"],
    ...
    grades: ["Food grade", "Air-dried", "80–100 mesh", "Moisture ≤ 8%"],
  ...
  },
  {
    ...
    features: ["Bright green colour, fresh heat", "Flakes and powder forms", "Controllable, consistent pungency", "No fresh-chilli spoilage"],
    uses: ["Seasonings and snack coatings", "Sauces, dips and chutneys", "Marinades and rubs", "Instant and ready meals"],
    grades: ["Food grade", "Air-dried", "Flakes / 60–80 mesh", "Moisture ≤ 8%"],
    forms: ["Powder", "Flakes"],
    drying: "Air-dried",
  },
  ...
  // ------------------------------------------------ FUNCTIONAL & NUTRITIONAL
  {
    ...
    features: ["Bright, natural citrus tang", "Convenient dry dosing", "Disperses readily", "No added acidulants"],
  ...
  },
  {
    ...
    features: ["Vivid natural red colour", "Clean-label colourant", "Earthy, mildly sweet taste", "Popular in sports nutrition"],
    uses: ["Natural food colouring", "Sports and nutrition blends", "Bakery, pasta and snacks", "Smoothies and lattes"],
    grades: ["Food grade", "Hot-air dried", "80–100 mesh", "Moisture ≤ 6%"],
    drying: "Hot-air dried",
  },
  {
    ...
    features: ["Rich umami tomato flavour", "Deep red natural colour", "Rehydrates to paste or sauce", "Space- and cost-efficient"],
    uses: ["Soups, sauces and ketchups", "Seasonings and snack dusts", "Ready meals and instant foods", "Bakery and savoury blends"],
    grades: ["Food grade", "Spray / drum-dried", "60–100 mesh", "Moisture ≤ 5%"],
    drying: "Spray / drum-dried",
  },
  {
    ...
    features: ["Natural orange colour", "Source of beta-carotene", "Sweet, mild flavour", "Clean single ingredient"],
  ...
  },
  {
    ...
    features: ["Sweet, tropical flavour", "Good source of fibre", "On-trend functional fruit", "Gluten-free flour alternative"],
    uses: ["Nutrition and meal blends", "Bakery and gluten-free flours", "Smoothies and beverages", "Snacks and cereals"],
    grades: ["Food grade", "Freeze / spray-dried", "80–100 mesh", "Moisture ≤ 6%"],
    drying: "Freeze / spray-dried",
  },
  ...
  // ------------------------------------------------------- HERBAL & LEAF
  {
    ...
    description:
      "Moringa leaves are among the most nutrient-dense greens on earth. We shade-dry them to protect their vivid colour and nutrition, then mill them into a fine powder used worldwide in supplements, green blends and functional foods.",
    features: ["Vibrant green, shade-dried", "Naturally nutrient-dense", "Fine, even particle size", "Trusted superfood ingredient"],
    uses: ["Capsules, tablets and supplements", "Green and smoothie blends", "Functional foods and bars", "Teas and herbal mixes"],
    grades: ["Food / nutraceutical grade", "Shade-dried", "80–100 mesh", "Moisture ≤ 7%"],
    drying: "Shade-dried",
  },
  {
    ...
    features: ["Authentic curry-leaf aroma", "Retained green colour", "Culinary and wellness use", "Long shelf life"],
    uses: ["Spice blends and seasonings", "Hair care and cosmetics", "Herbal and wellness mixes", "Snacks and savoury foods"],
    grades: ["Food grade", "Shade-dried", "80–100 mesh", "Moisture ≤ 7%"],
    drying: "Shade-dried",
  },
  {
    ...
    features: ["Classic Ayurvedic adaptogen", "Aromatic and herbaceous", "Gently dried for actives", "Clean single ingredient"],
  ...
  // ------------------------------------------- HYDROCOLLOIDS & FOOD ADDITIVES
  {
    ...
    tagline: "India's flagship thickener and stabiliser.",
    description:
      "Guar gum is a natural galactomannan extracted from the guar bean, and India produces the majority of the world's supply. It is a highly efficient cold-water thickener and stabiliser used across food, beverage, pharma and industrial sectors.",
    features: ["High viscosity at low dosage", "Cold-water soluble", "Natural, plant-based", "Food and industrial grades"],
    uses: ["Dairy, ice cream and sauces", "Bakery and gluten-free foods", "Beverages and dressings", "Pharma, pet food and industrial"],
    grades: ["Food / pharma / industrial grade", "Various viscosities", "100–200 mesh", "Moisture ≤ 12%"],
    drying: "Milled splits",
  },
  {
    ...
    features: ["Very high soluble-fibre content", "Forms a gel in water", "Clean-label digestive aid", "Gluten-free baking binder"],
  ...
  },
  {
    ...
    features: ["Natural polysaccharide gum", "Good thickening and gelling", "Cost-effective", "Food and technical grades"],
    uses: ["Food thickening and gelling", "Textile and jute sizing", "Paper and adhesives", "Industrial applications"],
    grades: ["Food / technical grade", "Plain & deoiled", "100–200 mesh", "Moisture ≤ 10%"],
    drying: "Milled kernel",
  },
  {
    ...
    features: ["Synergistic with other gums", "Strong gelling/stabilising", "Plant-based galactomannan", "Pet-food and food grades"],
